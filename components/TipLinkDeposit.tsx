...
const TipLinkDeposit: React.FC<ModalDepositProps> = ({
  isOpen,
  onClose,
  handleClick,
}) => {
            ...
            >
              <Flex justify="start" align="start" gap={3} w="full">
                ...
                <VStack alignItems="flex-start" w="full" spacing={2}>
                  ...
                  >
                    <span>
                      Deposit assets from your <b>Phantom</b> wallet.
                    </span>
                  </Text>
                </VStack>
              </Flex>
              ...
              <Flex justify="start" align="start" gap={3} w="full">
                ...
                <VStack alignItems="flex-start" w="full" spacing={2}>
                  ...
                  <Text
                    ...
                    className="text-gray-600 font-normal"
                  >
                    <span>Deposit assets via this TipLink's public key.</span>
                  </Text>
                </VStack>
              </Flex>
              <Icon as={ArrowForwardIcon} color="#2D4C5D" boxSize="6" />
...
export default React.memo(TipLinkDeposit)
